...
from .views import crear_posicion, guardar_punto, send_message_validada,login_view, home_view, historial_view, horario_view, main_view, register_view, logout_view, puntos_view, users_view, ConnectDeviceView, ConnectDevice2View, ConnectDevice3View, SolicitarHorarioView, SerialCommunicationView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', login_view, name = 'login'),
    path('crear_posicion/', crear_posicion, name='crear_posicion'),
    path('guardar_punto/', guardar_punto, name='guardar_punto'),
    ...
    path('serial_communication/', SerialCommunicationView.as_view(), name='serial_communication'),
